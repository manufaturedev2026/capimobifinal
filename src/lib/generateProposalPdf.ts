...
export async function generateProposalPdf(data: ProposalData) {
  ...
  final.text(`Proposta gerada em ${new Date().toLocaleDateString("pt-BR")}  •  Capimobi`, W / 2, H - 8, { align: "center" });
