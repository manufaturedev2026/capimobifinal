...
export default function TermsPage() {
  return (
    <>
      <Helmet>
        <title>Termos de Uso | Brokers App</title>
        <meta name="description" content="Termos de Uso do Brokers App. Conheça as condições de uso da nossa plataforma de anúncios de imóveis." />
      ...
      <div className="container max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-sm max-w-none text-foreground space-y-6">
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">Ao acessar ou utilizar o Brokers App, você concorda com estes Termos de Uso. Caso não concorde, não utilize a plataforma.</p>
          </section>

          <section>
            <h2 className="font-display font-bold text-xl mb-3">2. Descrição do Serviço</h2>
            <p className="text-muted-foreground leading-relaxed">O Brokers App é uma plataforma que conecta vendedores e compradores de imóveis em todo o Brasil. Atuamos como intermediários, fornecendo a plataforma para publicação e busca de anúncios.</p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 text-muted-foreground space-y-1">
              <li>O Brokers App oferece planos gratuitos e pagos para anunciantes</li>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">O Brokers App não se responsabiliza por:</p>
            <ul className="list-disc pl-6 text-muted-foreground space-y-1">
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">Todo o conteúdo da plataforma (design, código, marca, logotipos) é propriedade do Brokers App. Os anunciantes mantêm os direitos sobre suas fotos e descrições.</p>
          </section>
