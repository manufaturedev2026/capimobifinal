        ...
        >
          ...
          <div className="md:hidden relative">
            ...
            >
              {promoBanners.map((banner, bIdx) => (
                ...
                >
                  <div className="absolute inset-0" style={{ background: bIdx === 0 && theme.promoAccent ? `linear-gradient(to right, ${PRIMARY} 50%, #ffffff 50%)` : bIdx === 1 && theme.promoAccent ? `linear-gradient(to right, #ffffff 50%, ${theme.promoAccent} 50%)` : `linear-gradient(135deg, ${DARK_BASE}, ${PRIMARY}cc)` }} />
          ...
          <div className="hidden md:grid md:grid-cols-2 gap-4">
            {promoBanners.slice(0, 2).map((banner, bIdx) => (
              ...
              >
                <div className="absolute inset-0" style={{ background: bIdx === 0 && theme.promoAccent ? `linear-gradient(to right, ${PRIMARY} 50%, ${theme.promoAccent} 50%)` : bIdx === 1 && theme.promoAccent ? `linear-gradient(to right, #ffffff 50%, ${theme.promoAccent} 50%)` : `linear-gradient(135deg, ${DARK_BASE}, ${PRIMARY}cc)` }} />
                <div className="absolute inset-0 bg-gradient-to-r from-black/40 to-transparent" />
                <FloatingParticles color={bIdx === 0 && theme.promoAccent ? theme.promoAccent : PRIMARY} />
