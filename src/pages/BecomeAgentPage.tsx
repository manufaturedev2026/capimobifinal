...
const steps = [
  ...
  },
  {
    ...
    description: "Cadastre-se no Brokers App, crie seu perfil profissional e comece a captar clientes e fechar negócios.",
...
const skills = [
  ...
  { icon: Lightbulb, title: "Marketing Digital", description: "Aprenda a usar redes sociais, portais e o Brokers App para atrair clientes qualificados.", accent: true },
...
const testimonials = [
  {
    ...
    text: "Comecei do zero e hoje faturo mais de R$ 20 mil por mês. O Brokers App me deu visibilidade que eu não teria sozinho.",
    stars: 5,
  },
  {
...
const faqs = [
  ...
  {
    q: "O Brokers App cobra para anunciar?",
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={scaleIn}>
              <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-accent/15 text-accent text-xs font-bold uppercase tracking-widest mb-6 border border-accent/20">
                <Sparkles size={14} /> Exclusivo Brokers App
              </span>
            ...
            >
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl shadow-primary/20 border border-border">
                <img src={lojaNetflixImg} alt="Loja estilo Netflix do Brokers App" loading="lazy" className="w-full h-auto" width={1440} height={960} />
              </div>
              {/* Floating badge */}
              <motion.div
                animate={{ y: [0, -8, 0] }}
