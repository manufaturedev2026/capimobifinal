          ...
          <div className="md:hidden relative">
            ...
            >
              {promoBanners.map((banner, bIdx) => (
                ...
                >
                  <div className="absolute inset-0" style={{ background: theme.promoAccent ? `linear-gradient(135deg, ${theme.promoAccent} 0%, #ffffff 50%, ${PRIMARY} 100%)` : `linear-gradient(135deg, ${DARK_BASE}, ${PRIMARY}cc)` }} />
