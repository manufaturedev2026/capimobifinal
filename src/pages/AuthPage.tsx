  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row bg-background">
      ...
      <div className="relative w-full lg:w-1/2 h-[40vh] lg:h-auto lg:min-h-screen overflow-hidden">
        <img loading="lazy" decoding="async" src={heroImg} alt={site_name} className="absolute inset-0 w-full h-full object-cover" />
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 lg:p-12 lg:bottom-auto lg:top-1/2 lg:-translate-y-1/2">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            <div className="flex items-center gap-3 mb-6">
              <img loading="lazy" decoding="async" src={logoImg} alt={site_name} className="w-14 h-14 rounded-2xl object-contain" />
              <div>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.2 }} className="w-full max-w-md">
          {/* Mobile header */}
           <div className="lg:hidden text-center mb-6">
              <img loading="lazy" decoding="async" src={logoImg} alt={site_name} className="w-14 h-14 rounded-2xl object-contain mx-auto mb-3" />
