 ...
 *
 * Estética: imobiliária de alto padrão + tecnologia futurista elegante.
 * Foco em conversão. Sem visual gamer. Sem exagero.
 */
const CATEGORIES = [
...
export default function StoreLayoutCyberpunkMarketplace(props: StoreLayoutProps) {
  ...
  /* ── Inject fonts + global theme styles ── */
  useEffect(() => {
    ...
    style.textContent = `
      ...
      /* ============= KEYFRAMES ============= */
      @keyframes cp-grid-move {
        0% { background-position: 0 0; }
        100% { background-position: 60px 60px; }
      }
      @keyframes cp-orb {
        0%, 100% { transform: translate(0,0) scale(1); opacity: 0.32; }
        50% { transform: translate(30px,-20px) scale(1.08); opacity: 0.42; }
      }
        ...
        <section className="relative pt-24 md:pt-32 pb-12 md:pb-20 px-4 md:px-10">
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              {/* Title */}
              <h1
                className="font-bold tracking-tight text-[2.4rem] sm:text-5xl md:text-7xl leading-[1.05] mb-5"
                style={{
              ...
              >
                O futuro do <span style={{ background: "linear-gradient(90deg,#00F5FF,#8A2EFF)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>alto padrão</span>
                <br />começa aqui.
              </h1>
                ...
                >
                  ...
                  <div className="relative flex flex-col md:flex-row gap-1.5">
                    ...
                    {availableCities.length > 0 && setFilterCity && (
                      <>
                        <div className="hidden md:block w-px my-3 bg-white/8" />
                    ...
                    <button
                      onClick={() => {
                        document.getElementById("cp-grid")?.scrollIntoView({ behavior: "smooth" });
                      }}
        ...
        <section id="cp-grid" className="px-4 md:px-10 pb-20">
          <div className="max-w-7xl mx-auto">
            {visibleProducts.length === 0 ? (
              <div className="text-center py-20 text-[#A0A0B8]">
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="p-5">
                          <h3
                            className="text-[15px] font-semibold text-[#F5F5F5] line-clamp-1 mb-1"
                            style={{ fontFamily: "'Space Grotesk', sans-serif" }}
                          >
                            {p.title}
                          </h3>
